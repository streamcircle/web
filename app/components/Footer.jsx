...
export default function Footer() {
  ...
  const resourceLinks = [
    ['Documentation', 'https://docs.tweenly.io'],
    ...
    <footer style={{ background: 'var(--bg)', borderTop: '1px solid rgba(255,255,255,0.06)', padding: isMobile ? '48px clamp(20px,5vw,40px) 32px' : '64px 40px 32px' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : '1.6fr 1fr 1fr', gap: isMobile ? 32 : 40, marginBottom: 48 }}>
          <div style={{ gridColumn: isMobile ? '1 / -1' : 'auto' }}>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'rgba(226,228,229,0.55)', lineHeight: 1.6, maxWidth: 260, marginTop: 16 }}>
              Design broadcast overlays and control them on air. Built by PROVYS Technologies.
            </p>
          </div>
          <div>
            <div style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 700, letterSpacing: 2, color: 'rgba(226,228,229,0.45)', textTransform: 'uppercase', marginBottom: 16 }}>Resources</div>
          ...
          <div>
            <div style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 700, letterSpacing: 2, color: 'rgba(226,228,229,0.45)', textTransform: 'uppercase', marginBottom: 16 }}>Socials</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 11 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap', paddingTop: 28, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          <span style={{ fontFamily: 'var(--font-body)', fontSize: 12, color: 'rgba(226,228,229,0.45)' }}>© 2026 PROVYS Technologies</span>
          <span style={{ fontFamily: 'var(--font-body)', fontSize: 12, color: 'rgba(226,228,229,0.45)' }}>Prague · Olomouc · Poprad</span>
        </div>
      </div>
    </footer>
  );
